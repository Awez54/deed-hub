...
def feedback():
    ...
    q1_option = (request.form.get('q1_option'))
    q2_option = (request.form.get('q2_option'))
    q3_option = (request.form.get('q3_option'))
    
    comments = request.form['comments']

    cursor.execute("""
        INSERT INTO feedback
        (useful,Info_ok,overall_rate, comments)
        VALUES (%s, %s, %s, %s)
    """, (q1_option,q2_option,q3_option,comments))
...
def display_areas():
    ...
    taluk=[
        {"name":"Mysuru Taluk","price":"₹"},
        {"name":"Heggadadevanakote(H.D Kote)","price":"₹1,130"},
        {"name":"Hunsur","price":"₹1,000 - ₹2,500"},
        {"name":"Krishnarajanagara(K.R Nagar)","price":"₹2950"},
        {"name":"Nanjangud","price":"₹1675"},
        {"name":"Periyapatna","price":"₹2,100"},
        {"name":"T.Narsipu","price":"₹3798"},
    ]
...
def contact():
    if request.method == 'POST':
        ...
        app.config['MAIL_USERNAME'] = 'preethamrajgowda@gmail.com'
        app.config['MAIL_PASSWORD'] = 'AF096D57C44D902F744A0AF051B075E97BDD'
        ...
        msg = Message(subject, sender=sender_email, recipients=['himalatha2508@gmail.com'])
        msg.body = body
